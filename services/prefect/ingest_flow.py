...
def upsert_csv(table: str, csv_path: str, pk_cols: list[str]):
    ...
    # Conversion en booléen si les colonnes existent
...
def snapshot_month(as_of: str):
    """
    Crée les tables de snapshots si besoin et insère les données pour la date as_of.
    Chaque ligne est figée avec la colonne as_of pour le suivi temporel.
    """
    ddl = """
...
def ingest_month_flow(seed_dir: str = SEED_DIR, as_of: str = AS_OF):
    ...
    Charge les CSV, valide avec GE et crée les snapshots temporels.
    """
